...
def create_stacked_prompt(train_prompts, good_requests, prompt_amount):
...
def main():
    ...
    train_stacked_prompts, train_labels = create_stacked_prompt(train_prompts, good_requests, prompt_amount)
