...
class Trainer():
    ...
    def generate_predictions(self, bs = 5):
        test_data, _ = data_provider("test", torch = False, batch_size = self.config.batch_size, path = "../data/stacked_prompts_split_no_context.csv")
        ...
        test_data.to_csv("../data/stacked_prompts_split_no_context.csv")
