...
class Trainer():
    ...
    def generate_predictions(self, bs = 5):
        test_data, _ = data_provider("test", torch = False, batch_size = self.config.batch_size, path = "../data/stacked_prompts_split_0.0.csv")
        ...
        test_data.to_csv("../data/lcj_completion_begin_end_125_safe_demos_00.csv")
